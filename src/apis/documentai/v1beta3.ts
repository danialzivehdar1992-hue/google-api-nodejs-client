...
export namespace documentai_v1beta3 {
  ...
  export class Resource$Projects$Locations$Schemas {
    ...
    create(
      ...
      GaxiosResponseWithHTTP2<Schema$GoogleCloudDocumentaiV1beta3NextSchema>
    >;
    create(
      params: Params$Resource$Projects$Locations$Schemas$Create,
      options: StreamMethodOptions | BodyResponseCallback<Readable>,
    ...
    create(
      ...
      options:
        | MethodOptions
        | BodyResponseCallback<Schema$GoogleCloudDocumentaiV1beta3NextSchema>,
      callback: BodyResponseCallback<Schema$GoogleCloudDocumentaiV1beta3NextSchema>
    ): void;
    create(
      params: Params$Resource$Projects$Locations$Schemas$Create,
      callback: BodyResponseCallback<Schema$GoogleCloudDocumentaiV1beta3NextSchema>
    ...
    create(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1beta3/{+parent}/schemas').replace(
              /([^:]\/)\/+/g,
              '$1'
            ),
            method: 'POST',
      ...
      if (callback) {
        createAPIRequest<Schema$GoogleCloudDocumentaiV1beta3NextSchema>(
          parameters,
          callback as BodyResponseCallback<unknown>
        );
      } else {
        return createAPIRequest<Schema$GoogleCloudDocumentaiV1beta3NextSchema>(
          parameters
        );
      }
    }
    ...
    list(
      ...
      GaxiosResponseWithHTTP2<Schema$GoogleCloudDocumentaiV1beta3ListSchemasResponse>
    >;
    list(
      params: Params$Resource$Projects$Locations$Schemas$List,
      options: StreamMethodOptions | BodyResponseCallback<Readable>,
    ...
    list(
      ...
      options:
        | MethodOptions
        | BodyResponseCallback<Schema$GoogleCloudDocumentaiV1beta3ListSchemasResponse>,
      callback: BodyResponseCallback<Schema$GoogleCloudDocumentaiV1beta3ListSchemasResponse>
    ): void;
    list(
      params: Params$Resource$Projects$Locations$Schemas$List,
      callback: BodyResponseCallback<Schema$GoogleCloudDocumentaiV1beta3ListSchemasResponse>
    ...
    list(
      ...
      if (callback) {
        createAPIRequest<Schema$GoogleCloudDocumentaiV1beta3ListSchemasResponse>(
          parameters,
          callback as BodyResponseCallback<unknown>
        );
      } else {
        return createAPIRequest<Schema$GoogleCloudDocumentaiV1beta3ListSchemasResponse>(
          parameters
        );
      }
    }
  ...
  export class Resource$Projects$Locations$Schemas$Schemaversions {
    ...
    create(
      ...
      GaxiosResponseWithHTTP2<Schema$GoogleCloudDocumentaiV1beta3SchemaVersion>
    >;
    create(
      params: Params$Resource$Projects$Locations$Schemas$Schemaversions$Create,
      options: StreamMethodOptions | BodyResponseCallback<Readable>,
    ...
    create(
      ...
      options:
        | MethodOptions
        | BodyResponseCallback<Schema$GoogleCloudDocumentaiV1beta3SchemaVersion>,
      callback: BodyResponseCallback<Schema$GoogleCloudDocumentaiV1beta3SchemaVersion>
    ): void;
    create(
      params: Params$Resource$Projects$Locations$Schemas$Schemaversions$Create,
      callback: BodyResponseCallback<Schema$GoogleCloudDocumentaiV1beta3SchemaVersion>
    ...
    create(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1beta3/{+parent}/schemaVersions').replace(
              /([^:]\/)\/+/g,
              '$1'
            ),
            method: 'POST',
      ...
      if (callback) {
        createAPIRequest<Schema$GoogleCloudDocumentaiV1beta3SchemaVersion>(
          parameters,
          callback as BodyResponseCallback<unknown>
        );
      } else {
        return createAPIRequest<Schema$GoogleCloudDocumentaiV1beta3SchemaVersion>(
          parameters
        );
      }
    }
    ...
    generate(
      ...
      GaxiosResponseWithHTTP2<Schema$GoogleCloudDocumentaiV1beta3GenerateSchemaVersionResponse>
    >;
    generate(
      params: Params$Resource$Projects$Locations$Schemas$Schemaversions$Generate,
      options: StreamMethodOptions | BodyResponseCallback<Readable>,
    ...
    generate(
      ...
      options:
        | MethodOptions
        | BodyResponseCallback<Schema$GoogleCloudDocumentaiV1beta3GenerateSchemaVersionResponse>,
      callback: BodyResponseCallback<Schema$GoogleCloudDocumentaiV1beta3GenerateSchemaVersionResponse>
    ): void;
    generate(
      params: Params$Resource$Projects$Locations$Schemas$Schemaversions$Generate,
      callback: BodyResponseCallback<Schema$GoogleCloudDocumentaiV1beta3GenerateSchemaVersionResponse>
    ...
    generate(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (
              rootUrl + '/v1beta3/{+parent}/schemaVersions:generate'
            ).replace(/([^:]\/)\/+/g, '$1'),
            method: 'POST',
            apiVersion: '',
          },
      ...
      if (callback) {
        createAPIRequest<Schema$GoogleCloudDocumentaiV1beta3GenerateSchemaVersionResponse>(
          parameters,
          callback as BodyResponseCallback<unknown>
        );
      } else {
        return createAPIRequest<Schema$GoogleCloudDocumentaiV1beta3GenerateSchemaVersionResponse>(
          parameters
        );
      }
    }
    ...
    list(
      ...
      GaxiosResponseWithHTTP2<Schema$GoogleCloudDocumentaiV1beta3ListSchemaVersionsResponse>
    >;
    list(
      params: Params$Resource$Projects$Locations$Schemas$Schemaversions$List,
      options: StreamMethodOptions | BodyResponseCallback<Readable>,
    ...
    list(
      ...
      options:
        | MethodOptions
        | BodyResponseCallback<Schema$GoogleCloudDocumentaiV1beta3ListSchemaVersionsResponse>,
      callback: BodyResponseCallback<Schema$GoogleCloudDocumentaiV1beta3ListSchemaVersionsResponse>
    ): void;
    list(
      params: Params$Resource$Projects$Locations$Schemas$Schemaversions$List,
      callback: BodyResponseCallback<Schema$GoogleCloudDocumentaiV1beta3ListSchemaVersionsResponse>
    ...
    list(
      ...
      if (callback) {
        createAPIRequest<Schema$GoogleCloudDocumentaiV1beta3ListSchemaVersionsResponse>(
          parameters,
          callback as BodyResponseCallback<unknown>
        );
      } else {
        return createAPIRequest<Schema$GoogleCloudDocumentaiV1beta3ListSchemaVersionsResponse>(
          parameters
        );
      }
    }
