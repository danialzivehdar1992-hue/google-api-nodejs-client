...
export namespace developerknowledge_v1alpha {
  ...
  export class Resource$Documents {
    ...
    batchGet(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1alpha/documents:batchGet').replace(
              /([^:]\/)\/+/g,
              '$1'
            ),
            method: 'GET',
    ...
    searchDocumentChunks(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1alpha/documents:searchDocumentChunks').replace(
              /([^:]\/)\/+/g,
              '$1'
            ),
            method: 'GET',
  ...
  export class Resource$V1alpha {
    ...
    answerQuery(
      ...
      | Promise<GaxiosResponseWithHTTP2<Readable>> {
      let params = (paramsOrCallback ||
        {}) as Params$Resource$V1alpha$Answerquery;
      let options = (optionsOrCallback || {}) as MethodOptions;

      if (typeof paramsOrCallback === 'function') {
        callback = paramsOrCallback;
        params = {} as Params$Resource$V1alpha$Answerquery;
        options = {};
      }
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1alpha:answerQuery').replace(
              /([^:]\/)\/+/g,
              '$1'
            ),
            method: 'POST',
