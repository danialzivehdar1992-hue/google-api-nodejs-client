  ...
  export class Resource$Projects$Locations$Registrations {
    ...
    import(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1beta1/{+parent}/registrations:import').replace(
              /([^:]\/)\/+/g,
              '$1'
            ),
            method: 'POST',
    ...
    initiatePushTransfer(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (
              rootUrl + '/v1beta1/{+registration}:initiatePushTransfer'
            ).replace(/([^:]\/)\/+/g, '$1'),
            method: 'POST',
            apiVersion: '',
          },
    ...
    renewDomain(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1beta1/{+registration}:renewDomain').replace(
              /([^:]\/)\/+/g,
              '$1'
            ),
            method: 'POST',
        ...
        options: Object.assign(
          {
            url: (
              rootUrl +
              '/v1beta1/{+registration}:retrieveGoogleDomainsDnsRecords'
            ).replace(/([^:]\/)\/+/g, '$1'),
            method: 'GET',
            apiVersion: '',
          },
